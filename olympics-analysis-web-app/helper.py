...
def most_successful(df, sport):
  ...
  # .merge(df,left_on='index',right_on='Name',how='left')[['index','Name_x','sport','region']].drop_duplicates('index')
  # .merge(dfleft_on='index', right_on='Name', how='left')[['index', 'Name_x','Sport', 'region']].drop_duplicates('index')
